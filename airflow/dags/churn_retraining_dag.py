...
TRAIN_COMMAND = """
cd /opt/project/services/inference-service
python -m src.training.train \
  --train-path /opt/project/data/processed.csv \
  --test-path /opt/project/data/test_data.csv \
  --production-model-uri "${MODEL_URI}" \
