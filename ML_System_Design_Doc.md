...
**Данные и сущности:**
| Название данных | Источник / Витрина | Требуемый ресурс | Проверено качество |
| :--- | :--- | :--- | :--- |
| Транзакционная история | `train_data.csv` (локальный файл) | DS | + |
| Метки активности | Столбец `churn` в исходном датасете | DS | + |
