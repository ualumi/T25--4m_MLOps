...
В данном разделе зафиксирована стратегия валидации предиктивного механизма. В рамках текущей итерации, ввиду отсутствия прямого доступа к маркетинговому контуру и реальному пользовательскому трафику, пилот реализуется в формате **ретроспективной симуляции (Backtesting)**. Описанная методология фиксирует целевой дизайн эксперимента и закладывает требования к вычислительной сложности для последующего перехода к продуктовому A/B-тестированию.
