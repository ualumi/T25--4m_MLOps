...
* **Минусы выбора:**
    ...
    В базовой конфигурации масштабирование выполняется вручную; требуется настройка autoscaling.
    - Необходимость дополнительной настройки балансировщика и сетевой инфраструктуры.
    Балансировщик нагрузки (например, Nginx) требует отдельной конфигурации: маршрутизации, health-check.
